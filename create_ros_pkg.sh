...
SCRIPTS_CONTENT="#!/usr/bin/env python\n\nimport ${PKG_NAME}_ros.${PKG_NAME}_node\n\nif __name__ == '__main__':\n    ${PKG_NAME}_ros.${PKG_NAME}_node.main()"
...
ROS_NODE_CONTENT="#!/usr/bin/env python\n\nfrom ${PKG_NAME}.my_ros_independent_class import my_generic_sum_function\n\ndef main():\n    print 'success'"
...
touch common/src/${PKG_NAME}/my_ros_independent_class.py
touch package.xml
...
echo -e $ROS_INDEPENDENT_CLASS_CONTENT > common/src/${PKG_NAME}/my_ros_independent_class.py
...
echo -e $ROS_NODE_CONTENT > ros/src/${PKG_NAME}_ros/${PKG_NAME}_node.py
